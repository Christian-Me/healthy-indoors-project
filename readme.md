...
This project do not claim to prevent anybody form dangerous diseases or other harm. Stay distant, wear masks, perform any possible hygienic actions, think about possible ways to avoid long stays indoors.
...
- test if "self-measured" values can help in communication and behavior change
